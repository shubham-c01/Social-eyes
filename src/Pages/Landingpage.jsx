  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F3FF] via-purple-100 to-purple-300 font-sans">
      ...
      <div className="text-center pt-4">
        <h1 className="text-3xl text-[#1E1B4B] font-bold">
          Welcome to Social-Eyes
        </h1>
        <p className="text-[#1E1B4B] mt-1">Let's Create – Connect & Collect</p>
        <img
          src="/AppLogo.png"
          alt="App Logo"
      ...
      <div className="flex flex-col md:flex-row items-center justify-center px-4">
        ...
        <div className="w-full md:w-2/5 text-[#1E1B4B] p-2">
          ...
          <p className="text-sm mb-2">
            <strong>Social-eyes</strong> is a fresh take on modern social communication. It’s designed to bring people together in the simplest way possible — with just your phone number, you can instantly get started. No complicated steps, no cluttered UI — just pure connection.
          </p>
          <p className="text-sm mb-2">The workflow is designed to be frictionless:</p>
          <ul className="text-sm mb-3 ml-5 list-disc space-y-1">
